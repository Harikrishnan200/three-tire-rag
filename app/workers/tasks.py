...
def process_document_task(self, document_id: str, job_id: str, user_id: str, storage_path: str, content_type: str) -> None:
    asyncio.run(_run(document_id, job_id, user_id, storage_path, content_type))


async def _run(document_id: str, job_id: str, user_id: str, storage_path: str, content_type: str) -> None:
